...
\begin{enumerate}
	...
	\item Functionality and Security:
	      \begin{itemize}
		      ...
		      \item Security: Eve doesn't know about $k$, so he has to try every possible key $k' \in K$ to decode the ciphertext. However, different keys may lead to different messages, so Eve cannot be sure about the original message $m$.
	      \end{itemize}
\end{enumerate}
\begin{note}
